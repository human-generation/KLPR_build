                ...
                <div class="modal-body">
                    <form class="login-form" action="login" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input id="inputPassword" name="pw" type="password" class="form-control" autocomplete="current-password" required>
                        </div>
                ...
                <div class="modal-body">
                    <form class="signup-form" action="join" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input name="pw" id="signupPassword" type="password" class="form-control" autocomplete="new-password" required>
                        </div>
                        <div class="form-group">
                            <label for="passwordConfirm">Password confirm</label>
                            <input name="pw-confirm" id="passwordConfirm" type="password" class="form-control" autocomplete="new-password" required>
                        </div>
                        <div class="form-group">
    ...
    data-auto-logout-link="false" data-use-continue-as="false" data-width="" scope="public_profile,email"
