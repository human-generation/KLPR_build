...
public class HelperController {
	...
	public String getHelperList(@ModelAttribute("helper") HelperVO vo, @ModelAttribute("rReview") R_reviewVO evo, @ModelAttribute("seoul") SeoulVO svo,
			Model model) {
	...
	public String recentHelperList(@ModelAttribute("helper") HelperVO vo,  @ModelAttribute("rReview") R_reviewVO evo, @ModelAttribute("seoul") SeoulVO svo, Model model) {
	...
	public String moveHelper(@ModelAttribute("helper") HelperVO vo,  @ModelAttribute("rReview") R_reviewVO evo, @ModelAttribute("seoul") SeoulVO svo, Model model) {
	...
	public String hospitalHelper(@ModelAttribute("helper") HelperVO vo,  @ModelAttribute("rReview") R_reviewVO evo, @ModelAttribute("seoul") SeoulVO svo, Model model) {
	...
	public String immigrationHelper(@ModelAttribute("helper") HelperVO vo,  @ModelAttribute("rReview") R_reviewVO evo, @ModelAttribute("seoul") SeoulVO svo, Model model) {
	...
	public String seoulHelperList(@ModelAttribute("helper") HelperVO vo,  @ModelAttribute("rReview") R_reviewVO evo, @ModelAttribute("seoul") SeoulVO svo, Model model) {
