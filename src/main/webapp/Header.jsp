	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="login-form" action="login.do" method="post">
					<div class="form-group">
						<label for="inputEmail">Email address</label> <input
							id="inputEmail" name="email" type="email" class="form-control"
							autocomplete="username" required>
					</div>
					<div class="form-group">
						<label for="inputPassword">Password</label> <input
							id="inputPassword" name="pw" type="password" class="form-control"
				...
				<h5>OR</h5>
				<div class="sns-login">
					<a class="btn helper-button-main " href="#"><i
						class="fab fa-facebook"></i> Continue with Facebook</a>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="chat-form-container">
			...
			<div class="card chat-card">
				<div class="chat-card-header col-12 d-flex ">
					...
					<button type="button" class="btn chat-button-round p-2">
				...
				<div class="chat-room-list">
					<div class="row m-2 chat-room-indi">
						...
						<div class="col-9">
							<h5>{상대방 유저}</h5>
							<div>마지막메세지</div>
							<div class="d-flex flex-row-reverse">메세지날짜</div>
						</div>
					</div>
	...
	<div class="container-fluid footer">
		<div class="container">
			<div class="row">
				...
				<div class="col-sm">
					<div>
						© 2020 Kelper LLC <br> Â© 2020 Kelper LLC <br> <a
							class="footer-link" href="#">Terms of Service</a> | <a
							class="footer-link" href="#">Privacy Policy</a>
					</div>
				</div>
			</div>
		</div>
