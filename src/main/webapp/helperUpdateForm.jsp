		...
		<div class="row writeForm">
			...
			<div class="col-md-9 order-2 order-md-2">
				<div class="media-body">
					...
					<form class="helper-write-form" action="helperUpdate.do"
						method="post">
						<div class="row">
							<div class="col-md-6">
								<input name="uno" type="hidden"
									value="${sessionScope.userNumber}"> <input name="rno"
									type="hidden" value="${helper.rno}"> <input name="sta"
									type="hidden" id="date-result-start" value="${helper.sta}">
								<input name="end" type="hidden" id="date-result-end"
									value="${helper.end}"> <input type="text"
									id="datepicker" class="form-control form-control-sm"
									autocomplete="off" placeholder="${helper.sta} ~ ${helper.end}">
							</div>
							<div class="col-md-6">
								<select class="custom-select" disabled="disabled" name="lno"
									value="${helper.lno}">
						...
						<div class="form-group">
							...
							<textarea name="r_intro" class="form-control" rows="3"
								value="${helper.r_intro}">${helper.r_intro}</textarea>
						</div>
