...
<body>
	...
	<nav id="mainNavbar"
		...
		<div class="container">
			...
			<a href="#" class="navbar-brand"> <span class="logo"> <svg
						xmlns="http://www.w3.org/2000/svg" viewBox="0 0 273.32 56.7">
	 ...
	 <div class="jumbotron jumbotron-fluid">
        <div class="container jt-text">
            ...
            <div class="row float-right jt-btn m-1">
                <div class="dropdown">
                    <button class="btn helper-button dropdown-toggle" type="button" id="dropdownAddr"
        ...
        <div class="row">
            <div class="col-md-2 order-1 order-md-1 p-0 ">
                <div class="d-flex flex-column">
                    ...
                    <button type="button" class="btn  helper-button-main d-none d-md-block" onclick="location.href='helperWriteForm.do'">Let me help someone!
                    </button>


                </div>

                <button type="button" class="btn  helper-button-main mobile-write-btn d-md-none" onclick="location.href='helperWriteForm.do'">
